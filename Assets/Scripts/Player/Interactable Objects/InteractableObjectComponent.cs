// This script should be attached to all interactable objects (Layered objects with "Interactable"). Interactable objects are things like doors and buttons and not things that can be picked up.
